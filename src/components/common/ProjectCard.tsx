      ...
      <article className={`surface-card ${CARD_HOVER_CLASSES} rounded-2xl`}>
        <div className="bg-elevated relative h-56 overflow-hidden">
          ...
          <div className="absolute right-3 bottom-3 left-3 z-20">
            ...
            <h3 className="mt-2 line-clamp-2 text-xl leading-snug font-medium tracking-[-0.015em] text-white">
              {project.name}
            </h3>
          </div>
        </div>
        ...
        <div className="flex h-full flex-1 flex-col p-5">
          <p className="group-hover:text-primary text-heading text-2xl font-semibold tracking-[-0.01em] transition-colors duration-200">
