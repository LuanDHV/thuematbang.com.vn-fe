      ...
      <div className="mx-auto w-full max-w-7xl px-4">
        ...
        <div className="grid grid-cols-2 gap-6 md:grid-cols-2 lg:grid-cols-6">
          {categories.map((cat, index) => (
            <div
              key={index}
              className="group hover:border-primary/50 hover:shadow-primary/10 hover:-trangray-y-2 flex cursor-pointer flex-col items-center justify-center rounded-2xl border border-gray-200 bg-white p-8 shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all duration-300 hover:bg-white hover:shadow-xl"
            >
              {/* Icon Container */}
