...
export const mockRentRequests: RentRequest[] = [
  {
    ...
    thumbnailPublicId: "rent-request-2001",
    desiredCityId: 2,
  ...
  },
  {
    ...
    thumbnailPublicId: "rent-request-2002",
    desiredCityId: 3,
  ...
  },
  {
    ...
    categoryId: 1103,
    thumbnailUrl: "/imgs/wallpaper-3.jpg",
    thumbnailPublicId: "rent-request-2003",
    desiredCityId: 1,
  ...
  },
  {
    ...
    categoryId: 1102,
    thumbnailUrl: "/imgs/wallpaper-4.jpg",
    thumbnailPublicId: "rent-request-2004",
    desiredCityId: 1,
    ...
    minArea: 80,
    maxArea: 150,
    preferredDirection: "DONG",
    requirementText: "Cần khu đông dân cư, có thể setup quầy bar và bếp nóng.",
    contactName: "Trần Quốc Bảo",
    contactPhone: "0909000002",
    status: "ACTIVE",
    isFeatured: false,
  ...
  },
  {
    id: 2005,
    userId: 1,
    title: "Cần thuê nhà phố làm văn phòng đại diện tại Quận 7",
    slug: "can-thue-nha-pho-lam-van-phong-dai-dien-quan-7",
    categoryId: 1101,
    thumbnailUrl: "/imgs/wallpaper-5.jpg",
    thumbnailPublicId: "rent-request-2005",
    desiredCityId: 1,
    desiredDistrictId: 102,
    desiredWardId: 1002,
    desiredStreetId: 5002,
    ...
    requirementText:
      "Ưu tiên nhà có chỗ đậu ô tô, hợp đồng tối thiểu 2 năm, vào vận hành trong tháng.",
    contactName: "Nguyễn Minh An",
    contactPhone: "0909000001",
    status: "MATCHED",
    isFeatured: false,
    viewCount: 310,
    publishedAt: "2026-05-06T06:45:00.000Z",
    expiredAt: "2026-06-06T06:45:00.000Z",
  ...
  },
  {
    id: 2006,
    userId: 2,
    title: "Cần thuê mặt bằng mini 40-60m² gần phố đi bộ",
    slug: "can-thue-mat-bang-mini-40-60m2-gan-pho-di-bo",
    categoryId: 1102,
    thumbnailUrl: "/imgs/wallpaper-6.jpg",
    thumbnailPublicId: "rent-request-2006",
    desiredCityId: 1,
    desiredDistrictId: 101,
    desiredWardId: 1001,
    desiredStreetId: 5001,
    ...
    maxArea: 60,
    requirementText:
      "Mặt bằng nhỏ, ưu tiên góc ngã tư hoặc gần tuyến du lịch, phù hợp mô hình take-away.",
    contactName: "Trần Quốc Bảo",
    contactPhone: "0909000002",
    status: "ACTIVE",
    isFeatured: true,
    ...
    expiredAt: "2026-06-13T04:30:00.000Z",
    createdAt: "2026-05-13T04:30:00.000Z",
