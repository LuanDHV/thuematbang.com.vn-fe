  ...
  return {
    ...
    seoContents: [
      {
        ...
        page: "home",
        targetPath: "/",
        metaTitle: "Trang chủ demo",
        metaDescription: "Mo ta SEO demo cho trang chu.",
        seoContent: "<h2>Trang chủ demo</h2><p>Nội dung SEO trang chủ.</p>",
        isActive: true,
        createdAt: stamp(),
        updatedAt: stamp(),
      },
      {
        ...
        page: "cho-thue",
        targetPath: "/cho-thue",
        metaTitle: "Cho thuê demo",
        metaDescription: "Mo ta SEO demo cho trang cho thue.",
        seoContent: "<h2>Cho thuê demo</h2><p>Nội dung SEO cho thuê.</p>",
        isActive: true,
        createdAt: stamp(),
        updatedAt: stamp(),
      },
      {
        ...
        page: "can-thue",
        targetPath: "/can-thue",
        metaTitle: "Cần thuê demo",
        metaDescription: "Mo ta SEO demo cho trang can thue.",
        seoContent: "<h2>Cần thuê demo</h2><p>Nội dung SEO cần thuê.</p>",
        isActive: true,
        createdAt: stamp(),
        updatedAt: stamp(),
      },
    ...
    properties: [
      ...
      },
      {
        ...
        wardId: 12,
        ward: seedWards[1],
        addressDetail: "789 Nguyễn Văn Linh",
        longitude: 106.73,
        latitude: 10.73,
        contactName: "Test Customer",
        contactPhone: "0901000001",
        content: "Nội dung demo 3",
        viewCount: 2,
        status: "PUBLISHED",
        isFeatured: false,
        createdAt: stamp(),
    ...
    rentRequests: [
      ...
      },
      {
        id: 3,
        userId: 1,
        title: "Cần thuê biệt thự Quận 7",
        slug: "can-thue-biet-thu-quan-7",
        categoryId: 23,
        category: {
          id: 23,
          type: "RENT_REQUEST",
        ...
        requirementText: "Cần không gian rộng, phù hợp gia đình.",
        contactName: "Test Customer",
        contactPhone: "0901000001",
        status: "PUBLISHED",
        isMatched: false,
