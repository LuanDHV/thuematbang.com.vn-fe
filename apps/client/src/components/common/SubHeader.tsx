...
export default function SubHeader() {
  return (
    <div className="bg-inverse/95 border-inverse-border fixed top-0 right-0 left-0 z-50 border-b backdrop-blur-md">
      <div className="layout-container flex h-10 items-center justify-center">
        <Link href="tel:0968688081" className="inline-flex items-center gap-2">
          ...
          <span className="text-inverse-body text-[11px] font-bold tracking-[0.12em] uppercase">
            Hotline
          </span>
